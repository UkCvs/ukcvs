...
void time_shifted_service_descriptor(const t_service_id service_id, const t_transport_stream_id transport_stream_id, const t_original_network_id original_network_id, const t_satellite_position satellite_position, const uint32_t frequency)
{
	...
	else if (service_id == 0x0328 )
	{
		serviceName = "Playboy TV Nightly";
		providerName = "Adult";
		ch_num = 475;
	}
	else if (service_id == 0x05de)
	{
		serviceName = "Adult Channel Nightly";
		providerName = "Adult";
		ch_num = 477;
	}
	else if (service_id == 0x0773)
	{
		serviceName = "My Ex-Girlfriends";
		providerName = "Adult";
		ch_num = 478;
	}
	else if (service_id == 0x0260)
	{
		serviceName = "Red Hot 18s";
		providerName = "Adult";
		ch_num = 480;
	}
	else if (service_id == 0x0775)
	{
		serviceName = "RedHot Mums";
		providerName = "Adult";
		ch_num = 481;
	}
	else if (service_id == 0x06a8)
	{
		serviceName = "RedHotAmateur Nightly";
		providerName = "Adult";
		ch_num = 482;
	}
	else if (service_id == 0x0645)
	{
		serviceName = "XXX Mums";
		providerName = "Adult";
		ch_num = 484;
	}
